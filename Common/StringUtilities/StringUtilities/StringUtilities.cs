    ...
    public static class StringUtilities
    {
        ...
        */
        ...
        public static string HandleApostrophe(string strValue)
        {
            ...
            strNewValue = strNewValue.Replace("''", "'");
            strNewValue = strNewValue.Replace("'", "''");   // RMC 20231123 corrected error in deleting value with apostrophe, returned
            //strNewValue = strNewValue.Replace("'", "\'");   // RMC 20231016 corrected saving of resp center with apostrophe
